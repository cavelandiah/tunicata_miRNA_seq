...
In this context, we should select a number of species ($$x$$) to extract RNA and build smallRNA-specific libraries to have better representation of data along the Tunicata clade. 
